...
if __name__ == '__main__':
    ...
    print(net)
    # 创建tensorboard文件夹
    writer_train_loss = SummaryWriter('./runs' + args.dataset + args.model + '/train/' + 'baseline_noaug')
    writer_test_acc = SummaryWriter('./runs' + args.dataset + args.model + '/test/' + 'baseline_noaug')
    writer_test_acc5 = SummaryWriter('./runs' + args.dataset + args.model + '/test_top5/' + 'baseline_noaug')
    ...
    with open(logname, 'a') as logfile:
        ...
        logwriter.writerow(
            ['dataset:', args.dataset, 'model:', args.model, 'arg_method:', 'baseline_noaug', 'epoch:', args.epoch,
             'batch_size',
