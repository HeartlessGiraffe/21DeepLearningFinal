...
del sys
# 设置参数
parser = argparse.ArgumentParser(description='PyTorch CIFAR100 Training Cutout')
...
parser.add_argument('--cutout_prob', default=0.5, type=float,
...
if __name__ == '__main__':
    ...
    print(net)
    # 创建tensorboard文件夹
    writer_train_loss = SummaryWriter('./runs' + args.dataset + args.model + '/train/' + 'cutout')
    writer_test_acc = SummaryWriter('./runs' + args.dataset + args.model + '/test/' + 'cutout')
    writer_test_acc5 = SummaryWriter('./runs' + args.dataset + args.model + '/test_top5/' + 'cutout')
    ...
    with open(logname, 'a') as logfile:
        ...
        logwriter.writerow(
            ['dataset:', args.dataset, 'model:', args.model, 'arg_method:', 'cutout', 'epoch:', args.epoch,
             'batch_size',
